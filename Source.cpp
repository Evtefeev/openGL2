...
namespace
{
    ...
    glm::vec3 gCubePosition(1.0f, -1.0f, 0.0f);
    glm::vec3 gCubeScale(1.0f);

    // Cube and light color, edited to be white, I do not have an example of how to create multiple light sources or objects
    // m::vec3 gObjectColor(0.6f, 0.5f, 0.75f);
    glm::vec3 gObjectColor(1.f, 0.8f, 1.0f);
    glm::vec3 gLightColor(1.0f, 1.0f, 1.0f);

    // Light position and scale
    glm::vec3 gLightPosition(-1.5f, 1.5f, 3.0f);
...
int main(int argc, char *argv[])
{
    ...
    const char *texFilename = "tcone.png";
